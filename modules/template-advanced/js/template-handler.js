...
;(function( $ ){
    ...
    var templateHandlerADVANCED = function() {
        this.slider = null;
    ...
    templateHandlerADVANCED.prototype = {
        
        constructor: templateHandlerADVANCED,
        ...
        previewSingleSlide: function( id, display ) {
            ...
            var isStatic = ( $( 'input[name="slides[' + id + '][isStatic]"' ).length )? $( 'input[name="slides[' + id + '][isStatic]"' ).prop( 'checked' ) : false;
            ...
            if ( isStatic && ! display ) {
                slide.attr( 'data-u', 'any' ).css( 'z-index', 20 );
            }
            var caFx;
            ...
            if ( display ) {
                $.cnhkOverlay({
                    width: 94,
                    height: 85,
                    title: cnhkTemplateHandlerAdvancedLocale.singlePreview,
                    content: ss,
                });
                $.cnhkOverlay( 'show' );
        ...
        previewSlideshow: function () {
            ...
            $.cnhkOverlay({
                width: 94,
                height: 85,
                title: cnhkTemplateHandlerAdvancedLocale.ssPreview,
                content: ss,
            });
    ...
    $(function(){
        cnhkTemplateHandler['advanced'] = new templateHandlerADVANCED();
    });
