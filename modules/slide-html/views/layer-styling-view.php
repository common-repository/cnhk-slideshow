            ...
            <div class="styling-block-wrap" data-id="">
                <div class="styling-block-relwrap">
                    <div class="styling-block">
                        <p class="layer-para"><h4><?php _e( 'Layer name: ', 'cnhk-ss' ); ?><span class="layer-name-head"></span></h4></p>
                        ...
                        <div class="styling-field">
                            <input class="le cnhk-number" min="1" value="" type="number"  />
                        ...
                        <div class="styling-field">
                            ...
                            <p class="desc">
                                ...
                                <em><?php _e( '(does not work in IE 8)', 'cnhk-ss' ); ?></em>
                            </p>
                        </div>
...
<div id="apply-styling-div">
    <button id="apply-layer-styling" class="button button-primary alignright"><?php _e( 'Apply changes', 'cnhk-ss' ); ?></button>
</div>
