<div class="form-field">
    <label><?php _e( 'Amount of slides to display', 'cnhk-ss' ); ?>&nbsp:&nbsp;</label>
    <input type="text" class="cnhk-display-pieces cnhk-number" data-default="1" data-pat="\d+(?:\.\d+)?" name="options[_DisplayPieces]" id="options-_DisplayPieces" value="<?php echo $this->data['options']['$DisplayPieces'] ?>" />
    <p class="desc"><?php _e( 'How many slides should be visible at the same time. ( large number means it is a carousel )', 'cnhk-ss' ); ?></p>
</div>
<div class="form-field">
